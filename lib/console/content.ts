...
export const projects: Project[] = [
  {
    ...
    technologies: ['Next.js', '3D printing', 'Scheduling'], image: 'project-images/print-scheduler/Dashboard.png',
    ...
    sections: [
      ...
      { title: 'From job to schedule', paragraphs: ['Components are individual printable items, stored as 3MF files. Products group those components together. Jobs specify which products are needed, and the scheduler assigns the work to compatible printers.'], bullets: ['Match print-bed dimensions, nozzle sizes, materials, and multi-colour capabilities.', 'Allow prints to run overnight, while preventing new jobs from starting during away times.', 'Use preferred printers when a machine is particularly well suited to a component.'], image: 'project-images/print-scheduler/Schedule.png', caption: 'A schedule built around the printers and their constraints.' },
      { title: 'Printer compatibility', paragraphs: ['My A1 Mini has a small bed, a 0.4 mm nozzle, and an AMS for changing filaments. The P1S has a larger bed and a 0.6 mm nozzle; its CoreXY design makes it a good fit for larger prints with fewer colour changes. The A1 handles multi-colour changes efficiently, but its moving bed makes smaller prints a better fit.', 'Uploading a 3MF extracts the information needed to decide which printers can take the job. Multiple files can be attached to a component, so it can be considered for different machines.'], image: 'project-images/print-scheduler/component-preview.png', caption: 'Component information extracted from an uploaded 3MF file.' },
  ...
  },
  {
    ...
    technologies: ['Vue 3', 'Python / Flask', 'Raspberry Pi'], image: 'project-images/loveprint.png',
    ...
    sections: [
      ...
      { title: 'Drawing tools', paragraphs: ['Write a message, adjust its formatting, or add a drawing. The drawing canvas has an adjustable pen size and undo/redo controls. The home screen also shows whether the printer is connected.'], image: 'project-images/loveprint/drawing.png', caption: 'Drawing a message before sending it to the printer.' },
      { title: 'Printing', paragraphs: ['When a drawing is finished, you can remove it, download it, or send it alongside a message. The printer prints both the text and drawing.'], image: 'project-images/loveprint/drawing-and-message.png', caption: 'Text and drawings, ready to become a print.' },
      { title: 'Message history', paragraphs: ['The history view stores the messages you’ve sent, with options to revisit, delete, or print them again.'], image: 'project-images/loveprint/history.png', caption: 'A history of messages, ready to reprint.' },
    ],
  },
];
export const about = {
